export const fetchCurrentUser = () => {
	return (dispatch) => {
		return fetch(
      "https://kac-rails-client-9q83p2x50-ndishaw.vercel.app/authorized",
      {
...
export const logInUser = (userInfo) => {
	return (dispatch) => {
		...
		fetch("https://kac-rails-client-9q83p2x50-ndishaw.vercel.app/login", {
...
export const createUser = (userInfo) => {
	return (dispatch) => {
		...
		fetch("https://kac-rails-client-9q83p2x50-ndishaw.vercel.app/signup", {
